...
public abstract class By {
	...
	public static By onclick(final String onclick) {
		return new OnClick(onclick); 

	}
	
	static class OnClick extends By {
		private final String clickName;

		public OnClick(String clickName) {
	...
	//add by daiwenbin to getTitle
	static class GetTitle extends By {
